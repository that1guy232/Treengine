...
class Camera:
    def __init__(
        ...
        camera_min_x,
        camera_min_y,
        camera_max_x=10000000,
        camera_max_y=10000000,
    ):
        """
        ...
        self.rect = pygame.Rect(self.posistion.x, self.posistion.y, width, height)
    ...
    def move(self, delta):
        ...
        """
        self.posistion += (
            delta  # Update the camera's position by adding the delta vector.
        )
    ...
    def world_to_screen(self, pos):
        ...
        return (
            pos - self.posistion
        ) * self.zoom  # Adjust for the camera's position and zoom level.
